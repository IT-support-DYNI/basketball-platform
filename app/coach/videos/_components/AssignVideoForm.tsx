...
export default function AssignVideoForm({ videoId, teams }: { videoId: number; teams: TeamOption[] }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button type="button" onClick={handleAssign} disabled={loading || !teamId} className="rounded-full bg-flame px-3 py-1 text-xs font-semibold text-on-flame disabled:opacity-50">
